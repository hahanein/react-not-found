...
export const Button = ({ globalState, dispatch }) => {
    ...
    return (_jsx("li", { children: _jsxs("button", { "aria-label": globalState.theme === ThemeState.Light ? darkText : lightText, title: globalState.theme === ThemeState.Light ? darkText : lightText, onClick: () => {
                const newTheme = globalState.theme === ThemeState.Light
                    ? ThemeState.Dark
                    : ThemeState.Light;
                document.documentElement.setAttribute("data-theme", newTheme);
                dispatch({ type: ActionType.UpdateTheme, value: newTheme });
            }, type: "button", children: [_jsx(Bulb, {}), _jsx("span", { className: "ladle-addon-tooltip", children: globalState.theme === ThemeState.Light ? darkText : lightText }), _jsxs("label", { children: ["Switch to", " ", globalState.theme === ThemeState.Light
                            ? ThemeState.Dark
