...
export const Button = () => {
    ...
    return (_jsx("li", { children: _jsxs("button", { "aria-label": text, "data-testid": "addon-a11y", title: text, onClick: () => {
